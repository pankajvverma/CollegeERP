...
public partial class Admin_Master_searchbyname : System.Web.UI.Page
{
    ...
    protected void abc(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("searchbyname personal.aspx?id=" + a);
    }
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string s, value;
        value = TextBox1.Text;
        s = "select * from studentreg where ename like '%" + value + "%'";
        ds = dc.getdata(s);
